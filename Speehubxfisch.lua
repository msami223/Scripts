...
-- Define your distributor ID here
local DISTRIBUTOR_ID = "cbbda565" -- Replace with your distributor ID
...
local function createKeyUI()
    ...
    if DISTRIBUTOR_ID and DISTRIBUTOR_ID ~= "DISTRIBUTOR_ID_HERE" then
        ...
        DistributorLabel.Text = "Distributor: " .. DISTRIBUTOR_ID
...
local function verifyKey(key)
    -- Base verification URL - replace with your actual domain
    local baseUrl = "https://wordpress-1442530-5466128.cloudwaysapps.com/?verify=1"
    
    -- Add distributor parameter if available
    local url = baseUrl
    if DISTRIBUTOR_ID and DISTRIBUTOR_ID ~= "DISTRIBUTOR_ID_HERE" then
        url = url .. "&distributor=" .. DISTRIBUTOR_ID
    end
...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://raw.githubusercontent.com/AhmadV99/Speed-Hub-X/main/Speed%20Hub%20X.lua"))()
...
local function initKeySystem()
    ...
    ui.GetKeyButton.MouseButton1Click:Connect(function()
        -- Website URL to get key with distributor parameter if available
        local keyWebsite = "https://wordpress-1442530-5466128.cloudwaysapps.com/"
        if DISTRIBUTOR_ID and DISTRIBUTOR_ID ~= "DISTRIBUTOR_ID_HERE" then
            keyWebsite = keyWebsite .. "?distributor=" .. DISTRIBUTOR_ID
        end
